...
@NonNullApi
public class CeramicAnalizeAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CeramicAnalizeAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
